...
export class AddSpace1656580584768 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "space" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT timezone('utc', now()), "update_at" TIMESTAMP NOT NULL DEFAULT timezone('utc', now()), "owner_id" uuid, CONSTRAINT "REL_9114b5dd2c691b98d7fa3f10b2" UNIQUE ("owner_id"), CONSTRAINT "PK_094f5ec727fe052956a11623640" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
