...
export class AddAccount1657287850180 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "account" ADD CONSTRAINT "FK_a55842d3341d42534e39f85e931" FOREIGN KEY ("token_id") REFERENCES "monobank_token"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "account" DROP CONSTRAINT "FK_a55842d3341d42534e39f85e931"`);
