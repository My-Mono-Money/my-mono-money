  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "space_member_invitation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "status" "public"."space_member_invitation_status_enum" NOT NULL, "space_id" uuid, CONSTRAINT "UQ_4a8e8b63e2d90c9dcaca92cbd1c" UNIQUE ("email", "space_id"), CONSTRAINT "PK_c70e81bea276d29e8ac4236b031" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
